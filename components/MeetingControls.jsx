      ...
      {isCurrentUserSharing ? (
        ...
        <>
          <button
            ...
            title={movieShareDisabled ? 'Someone else is sharing' : 'Share Movie File'}
          >
            {isUploadingMovie ? (
          ...
          <button
            ...
            disabled={movieShareDisabled || isUploadingMovie}
            className={`p-3 rounded-full ${movieShareDisabled ? 'bg-gray-600' : 'bg-purple-600 hover:bg-purple-700'}`}
